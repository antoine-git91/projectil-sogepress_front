                    ...
                    { (tabActive === "contact" &&
                        <SingleMainContainer>
                            <InfoViewContainer>
                                <h2>Coordonnées</h2>
                                <InfoContainer>
                                    <BoxInfos titre="Téléphone" information={items.hasOwnProperty("contacts") ? items.contacts[0].tel : "---"} />
                            ...
                            <ContactViewContainer>
                                <h2>Contact</h2>
                                <ContactContainer>
                                    <BoxContact nom={items.hasOwnProperty("contacts") ? items.contacts[0].nom : "---"} prenom={items.hasOwnProperty("contacts") ? items.contacts[0].prenom : "---"} fonction={items.hasOwnProperty("contacts") ? items.contacts[0].fonction : "---"} mail={items.hasOwnProperty("contacts") ? items.contacts[0].email : "---"} tel={items.hasOwnProperty("contacts") ? items.contacts[0].tel : "---"}/>
                                    <BoxContact />
                                    <BoxContact />
                                </ContactContainer>
                            </ContactViewContainer>
