...
const Commande = () => {
    ...
    const adresseClient = commande.client ? commande.client.adresse[ 0 ] : "" ;
        ...
        return (
            <>
                <MainContainer>
                    ...
                    <BoxTitle>
                        <h1>{getType()} / <Link to={ commande.client && "/profile/" + commande.client.id }>{ commande.client ? commande.client.raisonSociale : "loading" }</Link></h1>
